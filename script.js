...
const apps = [
  ...
  },
  {
    ...
    descriptionKo: "컬러마스터2 이전에 만든 원작 버전입니다. 웹에서 먼저 플레이해보고, Google Play에서 설치할 수 있습니다.",
    descriptionEn: "The original version before Color Master 2. Play it on the web first, then install it from Google Play.",
    ...
    statusNoteKo: "웹에서 먼저 플레이해보고, Google Play에서 설치할 수 있습니다.",
    statusNoteEn: "Play it on the web first, then install it from Google Play."
  },
  {
