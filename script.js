...
const apps = [
  ...
  },
  {
    ...
    descriptionKo: "컬러마스터2 이전에 만든 원작 버전입니다. 웹 미리보기에서 게임 방식을 확인하고, Google Play에서 설치할 수 있습니다.",
    descriptionEn: "The original version before Color Master 2. Preview how it plays on the web, then install it from Google Play.",
    ...
    statusNoteKo: "웹 미리보기에서 게임 방식을 먼저 확인하고, Google Play에서 설치할 수 있습니다.",
    statusNoteEn: "Preview how the game works on the web, then install it from Google Play."
  },
  {
