...
export const SERIAL_EDITORIAL_POLICY_VERSION = "2026-08-03-novelty-calibration-v6";
...
function resultContract(type) {
  ...
  if (type === "build_bible") return {
    ...
    narrativeBlueprint: { informationStrategy: "정보 공개 원칙", openingModes: ["3-7개 도입 방식"], signatureTechniques: ["3-7개 창작 기법"], escalationPattern: "갈등 상승 방식", revealCadence: "복선과 진실 공개 간격", noveltyPolicy: "참신성 목표와 새 요소 추가 제한", antiRepetitionRules: ["3-10개 반복 방지 규칙"] }
  };
