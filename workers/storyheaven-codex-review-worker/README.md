...
New concepts created under editorial policy `2026-08-09-story-development-v18` use a writer-only four-candidate pass followed by an editor-only immutable selection pass. The selected concept retains an auditable selection report, a binding story core, richer character and relationship dynamics, and causal world pressures. Episode cards rotate dramatic modes, explicit choice-cost chains, unresolved reader promises, emotional debts, and recent-pattern variation. Six isolated critic jobs inspect character, relationship, serial momentum, world causality, scene expression, and skeptical-reader risk before a final editor copies and weighs their evidence. A positive voluntary next-read verdict remains mandatory; legacy jobs and stories continue under their previous contracts without retroactive rewriting. The diagnosis, boundaries, and phased roadmap are documented in [serial-quality-v2-plan.md](../../storyheaven/serial-quality-v2-plan.md).
