...
Editorial policy `2026-08-30-genre-voice-quality-v30` adds server-owned long-form fantasy experience presets and prose-voice presets for new schedules. Random choices resolve once, the prose contract is attached to the story bible, and final review gates voice adherence, dialogue characterization, tone consistency, and sentence rhythm independently from basic readability. Legacy schedules keep their stored genre and voice. The remaining private voice-audition and compact-packet phases, non-imitation boundary, rollout gates, and test matrix are documented in [serial-quality-v3-plan.md](../../storyheaven/serial-quality-v3-plan.md).
