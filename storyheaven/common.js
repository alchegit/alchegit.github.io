(() => {
  ...
  function readableError(error) {
    return ({
      ...
      serial_story_work_active: "이 작품의 다른 제작 작업이 진행 중입니다. 완료되거나 중단된 뒤 장편 설계를 보강해주세요.",
      serial_plan_required: "설정집과 장기 흐름을 먼저 만들어주세요.",
      serial_architecture_required: "전체 권별 전개와 장기 복선이 아직 준비되지 않았습니다. 연재 작품 관리에서 장편 설계 보강을 먼저 실행해주세요.",
      serial_series_complete: "설정한 전체 권수와 화수를 모두 제작한 작품입니다.",
      ...
      serial_bulk_story_selection_required: "변경할 작품을 한 편 이상 선택해주세요.",
      serial_bulk_story_limit: "한 번에 최대 100편까지 변경할 수 있습니다.",
      serial_bulk_story_update_failed: "일부 작품의 공개 상태를 변경하지 못했습니다.",
      serial_story_date_filter_invalid: "제작 기간 날짜를 다시 확인해주세요.",
      serial_story_date_range_invalid: "제작 시작일은 종료일보다 늦을 수 없습니다.",
